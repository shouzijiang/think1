    ...
    <view class="form-wrap">
      ...
      <view class="btn-wrap">
        <view
          ...
          :hover-class="submitting || !content.trim() ? 'none' : 'btn-submit--hover'"
          :hover-start-time="20"
          :hover-stay-time="100"
          @click="submit"
        >
...
useWechatPageShare('意见反馈 · 谐音梗猜一猜', shareRewardQuotaRef)
...
function back() {
  uni.navigateBack({ fail: () => { uni.reLaunch({ url: '/pages-sub/levels/levels' }) } })
}
